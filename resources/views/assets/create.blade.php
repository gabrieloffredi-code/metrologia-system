<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Cadastrar Peça em:') }} {{ $laboratory->name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- O action usa o nome da rota aninhada: laboratories.assets.store --}}
                    <form method="POST" action="{{ route('laboratories.assets.store', $laboratory) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="nominal_value" class="block mt-1 w-full" type="number" step="0.0001" name="nominal_value" :value="old('nominal_value')" placeholder="Ex: 10.0000" />
